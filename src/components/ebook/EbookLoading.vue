        ...
        mounted() {
            this.task = setInterval(() => {
             this.$refs.mask.forEach((item, index) => {
                 ...
                 mask.style.width = `${px2rem(maskWidth.value) * 2}rem`
                 mask.style.flex = `0 0 ${px2rem(maskWidth.value) * 2}rem`
                 line.style.width = `${px2rem(lineWidth.value) * 2}rem`
                 line.style.flex = `0 0 ${px2rem(lineWidth.value) * 2}rem`
